...
public interface Dao<T> {
     ...
     */
    Serializable add(@NotNull T element) throws NameAlreadyBoundException;
     ...
     */
    void delete(@NotNull T element) throws NameNotFoundException;
     ...
     */
    void deleteById(@NotNull Serializable id) throws NameNotFoundException, InvalidNameException;
     ...
     * @throws InvalidNameException Si la syntaxe de la clé n'est pas conforme au type attendu
     */
    void update(@NotNull Serializable id, T element) throws InvalidNameException;
     ...
     */
    Serializable getId(@NotNull T element) throws NameNotFoundException;
     ...
     * @throws InvalidNameException Si la syntaxe de la clé n'est pas conforme au type attendu
     */
    T findOne(@NotNull Serializable id) throws NameNotFoundException, InvalidNameException;
